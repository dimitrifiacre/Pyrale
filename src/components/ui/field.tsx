...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "has-data-checked:bg-primary/5 has-data-checked:border-primary/30 dark:has-data-checked:border-primary/20 gap-2 group-data-[disabled=true]/field:opacity-disabled has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5 group/field-label peer/field-label flex w-fit leading-snug",
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "gap-2 text-sm font-normal group-data-[disabled=true]/field:opacity-disabled flex w-fit items-center leading-snug",
        className
      )}
      {...props}
    />
